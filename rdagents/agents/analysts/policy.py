"""🏛️ 정책 부합성 분석가 — 사업 분야별 법정계획·상위정책·정부 책무 정합성."""
...
def create_policy_analyst(llm):
    def policy_analyst_node(state):
        ...
        system_message = (
            ...
            "1. **분야별 법정계획·상위정책 정합성**: 사업 목적과 직접 관련된 법률, 법정계획, 국가계획과 부합하는가? "
            "재난안전 사업은 재난 및 안전관리 관련 법·계획과 지역 재난안전 수요를 우선 확인하세요.\n"
            "2. **과학기술 기본계획·국가전략기술 연계성**: 직접 관련될 때만 근거로 사용하고, 국가전략기술 비해당 자체를 감점하지 마세요.\n"
            "3. **정부 책무와 공공성**: 국민 생명·재산 보호, 취약계층 보호, 지역 안전격차 완화 등 정부가 책임져야 할 공공임무가 명확한가?\n"
            "4. **범부처·중앙-지방 정책 정합성**: 관련 중앙부처와 지방정부의 역할, 기존 재난안전 사업과의 연계·중복은 적절한가?\n"
